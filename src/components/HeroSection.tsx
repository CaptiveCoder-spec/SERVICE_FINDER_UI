        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight opacity-0 animate-fadeIn">
              <span className="text-gradient">Find Trusted Local Services</span>
            ...
            <div className="flex flex-wrap gap-4 opacity-0 animate-fadeIn delay-300">
              <Link to="/discover">
                <Button size="lg" className="rounded-full bg-brand-500 hover:bg-brand-600 text-white px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  Search Now
                </Button>
              </Link>
              <Button 
                variant="outline" 
                size="lg" 
                className="rounded-full border-2 px-8 py-6 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300"
              >
                List Your Service
              </Button>
            </div>
